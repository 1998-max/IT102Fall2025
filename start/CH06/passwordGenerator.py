...
Interactive secure password generator for IT102 CH06
Requirements:
 - Ask length (>=8)
 - Ask whether to include uppercase / lowercase / digits / special chars
 - Ensure at least one char from each selected category
 - Offer to generate another password or exit
Author: David Tshibamba (replace name if you want)
"""
